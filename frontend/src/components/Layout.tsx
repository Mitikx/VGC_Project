// Layout global : sidebar + bottom nav
        ...
        <div className="hidden md:flex md:flex-col h-full">
          ...
          {user && (
            <div className="p-3 border-t border-border1">
              <div className="text-xs text-text2 mb-2">Connecté</div>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-bg2 border-t border-border1 flex z-40">
        {NAV_ITEMS.map((it) => (
          <NavLink
            ...
            className={({ isActive }) =>
              `flex-1 flex flex-col items-center gap-1 py-3 text-[9px] uppercase font-semibold tracking-wider transition ${
